    ...
    <div class="middle col-6">
        <div class="{{ Route::is('umat.login') or (Route::is('umat.register') ? 'd-none' : '') }} align-self-center justify-content-center collapse navbar-collapse"
            ...
            <ul class="navbar-nav fs-6">
                ...
                {{-- Home --}}
                <li class="nav-item">
                    <a class="nav-link {{ Route::is('home') ? 'text-secondary' : 'text-primary hvr-push' }} me-2"
                        href="/home">Beranda</a>
                </li>

                {{-- Profile --}}
                <li class="nav-item">
                    <a class="nav-link {{ (Route::is('visiMisi') or Route::is('doa') or Route::is('fasilitas') or Route::is('pastor') or Route::is('kegiatan')) ? 'text-secondary' : 'text-primary hvr-push' }} me-2"
                        href="/profil/sejarahVisiMisi">Profil</a>
                </li>

                {{-- Jadwal --}}
                <li class="nav-item">
                    <a class="nav-link {{ Route::is('jadwal') ? 'text-secondary' : 'text-primary hvr-push' }} me-2"
                        href="/jadwal">Jadwal</a>
                </li>

                {{-- Layanan --}}
                <li class="nav-item">
                    <a class="nav-link {{ Route::is('layanan') ? 'text-secondary' : 'text-primary hvr-push' }} me-2"
                        href="/layanan">Layanan</a>
                </li>

                {{-- Hubungi kami --}}
                <li class="nav-item">
                    <a class="nav-link {{ Route::is('hubungi') ? 'text-secondary' : 'text-primary hvr-push' }}"
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select  @error('status') is-invalid @enderror" id="status"
                                ...
                                <option value="belum_menikah"
                                    {{ Auth::user()->status == 'belum_menikah' ? 'selected' : '' }}>Belum Menikah
                                </option>
                                <option value="lainnya" {{ Auth::user()->status == 'lainnya' ? 'selected' : '' }}>
                                    Lainnya
                                </option>
                            </select>
                            @error('status')
