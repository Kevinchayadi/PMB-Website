    ...
    <div class="section-2 d-flex">
        <div class="left col-lg-8 col-12">
            ...
            <div class="d-flex ms-3 me-4 row">
                <div class="left-content text-gray px-2 align-self-center col-1">
                    <div class="d-flex justify-content-center">
                        ...
                        <div class="h4 ms-2 align-self-center">02</div>
                    </div>
                    <div class="h5 text-center">Januari</div>
                </div>
                <div class="right-content pe-2 border-start border-gray col-11 d-flex justify-content-between">
                    ...
                    <div class="button align-self-center text-end">
                        <div class="btn btn-outline-primary text-primary bg-white">
