...
@section('content')
    ...
    <div class="footer row justify-content-center mb-4 px-lg-2">
        ...
        <div class="section-3 col-lg-4 col-12 mt-2 ps-lg-0 ps-4">
            <iframe src="https://maps.google.com/maps?q=Jl.%20Raya%20Mangga%20Besar%20No.55%201,%20RT.1/RW.3,%20Tangki,%20Kec.%20Taman%20Sari,%20Kota%20Jakarta%20Barat,%20Daerah%20Khusus%20Ibukota%20Jakarta%2011170&amp;t=&amp;z=17&amp;ie=UTF8&amp;iwloc=&amp;output=embed" width="100%" height="250px">
            </iframe>
        </div>
    </div>
