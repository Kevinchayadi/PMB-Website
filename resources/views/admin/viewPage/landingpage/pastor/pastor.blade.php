...
@section('content')
    <div class="d-flex justify-content-end  align-items-center my-3  text-center">
        <h1 class="mb-0 fw-bold  p-2 text-white bg-primary shadow rounded-start-2">Pastor List</h1>
    ...
    <div class="px-4">
        ...
        <div class="event rounded-3 shadow-lg bg-primary">
            <div class="event-inner ms-2 bg-white p-4 rounded-end row">
                <div class="col-10 event-title fs-5 fw-bolder text-primary">Pastor A</div>
                <div class="col-2 action d-flex justify-content-evenly">
                    <a href="/admin/edit-pastor/0" class="nav-link text-primary">Edit</a>
                    <a href="/admin/delete-pastor/0" class="nav-link text-danger">Delete</a>
                </div>
            </div>
        </div>
    </div>
