                            ...
                            <form action="/admin/add-pastor" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control @error('jabatan') is-invalid @enderror" name="jabatan"
                                        ...
                                        <option value="Pastor Paroki" {{ old('jabatan') == 'Pastor Paroki' ? 'selected' : '' }}>Pastor Paroki</option>
                                        <option value="Romo Tamu" {{ old('jabatan') == 'Romo Tamu' ? 'selected' : '' }}>Romo Tamu</option>
                                        <option value="Pastor Pembantu Paroki" {{ old('jabatan') == 'Pastor Pembantu Paroki' ? 'selected' : '' }}>Pastor Pembantu Paroki</option>
                                    </select>
                                    @error('jabatan')
                                        <div class="invalid-feedback text-white">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="file" class="form-control @error('foto') is-invalid @enderror"
                                        id="foto" name="foto" placeholder="Masukkan gambar" onchange="previewImage(event)">
                                    @error('foto')
                                        <div class="invalid-feedback text-white">{{ $message }}</div>
                                    @enderror
                                </div>
