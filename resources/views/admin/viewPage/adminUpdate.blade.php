            ...
            <div class="card shadow-lg bg-primary text-white">
                <div class="card-body">
                    ...
                    <form action="{{ url('/admin/admin-detail/' . $admin->username) }}" method="POST">
                        ...
                        <!-- Password -->
                        <div class="mb-3">
                            <label for="password" class="form-label text-white">Password (Kosongkan jika tidak ingin diubah)</label>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control @error('id_role') is-invalid @enderror" id="role" name="role" required>
