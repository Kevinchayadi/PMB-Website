<div class="footer row justify-content-center mx-auto container-fluid border-top">
    {{-- Informasi --}}
    <div class="section-1 col-lg-2 col-5">
        <div class="">
            ...
            <div class="fs-6">
                ...
                <a class="nav-link text-primary mb-1" href="/profile/profile">Profil</a>
    ...
    <div class="section-2 col-lg-2 col-5">
        ...
        {{-- Facebook --}}
        <a class="facebook d-flex align-content-center mb-1 nav-link" href="https://facebook.com">
        ...
        {{-- Instagram --}}
        <a class="instagram d-flex align-content-center mb-1 nav-link" href="https://instagram.com">
            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="#818181"
        ...
        {{-- Youtube --}}
        <a class="youtube d-flex align-content-center nav-link" href="https://youtube.com">
            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="#818181"
