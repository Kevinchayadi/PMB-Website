<div class="footer row justify-content-center mx-auto border-top py-2">
    {{-- Ikuti kami --}}
    <div class=" {{ Route::is('hubungi') ? 'd-none' : '' }} section-2 col-lg-2 col-6 p-2 h-100 ">
        <div class="fs-5 text-center">Ikuti Kami</div>

        <div class="ps-2 row justify-content-center text-center">
            {{-- Facebook --}}
    ...
    {{-- Google map --}}
    <div class="section-3 col-lg-4 col-6 my-3 px-2 h-25">
        <iframe
