...
Route::put('/editRequest/{slug}', [RequestController::class, 'updateRequest'])->name('updateRequest');
Route::put('/cancelRequest/{slug}', [RequestController::class, 'cancelRequest'])->name('cancelRequest');
