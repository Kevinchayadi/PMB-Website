<div
    class="footer row justify-content-center mx-auto border-top py-2 shadow-sm h-25 pb-0 <?php echo e(Route::is('hubungi') ? 'd-none' : ''); ?>">
    
    <div class="section-2 col-lg-2 col-4 p-2 h-25 ">
    ...
    <div class="section-3 col-lg-4 col-6 my-2 mx-2 h-25 px-0">
        ...
        <iframe
            ...
            width="100%" height="100px" class="rounded-3 shadow-lg">
        </iframe>
    </div>
</div>
<?php /**PATH D:\laragon\www\PMB-Website\resources\views/user/Layout/footer.blade.php ENDPATH**/ ?>