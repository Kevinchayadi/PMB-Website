    ...
    <div class="middle col-6">
        <div class="<?php echo e(Route::is('umat.login') or (Route::is('umat.register') ? 'd-none' : '')); ?> align-self-center justify-content-center collapse navbar-collapse"
            ...
            <ul class="navbar-nav fs-6">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo e(Route::is('home') ? 'text-secondary' : 'text-primary'); ?> me-2"
                        href="/home">Home</a>
                </li>

                
                <li class="nav-item">
                    <a class="nav-link <?php echo e((Route::is('visiMisi') or Route::is('sejarah') or Route::is('doa') or Route::is('fasilitas') or Route::is('pastor') or Route::is('kegiatan')) ? 'text-secondary' : 'text-primary'); ?> me-2"
                        href="/profile/visiMisi">Profil</a>
                </li>

                
                <li class="nav-item">
                    <a class="nav-link <?php echo e(Route::is('jadwal') ? 'text-secondary' : 'text-primary'); ?> me-2"
                        href="/jadwal">Jadwal</a>
                </li>

                
                <li class="nav-item">
                    <a class="nav-link <?php echo e(Route::is('layanan') ? 'text-secondary' : 'text-primary'); ?> me-2"
                        href="/layanan">Layanan</a>
                </li>

                
                <li class="nav-item">
                    <a class="nav-link <?php echo e(Route::is('hubungi') ? 'text-secondary' : 'text-primary'); ?>"
...
<?php /**PATH D:\laragon\www\PMB-Website\resources\views/Layout/header.blade.php ENDPATH**/ ?>