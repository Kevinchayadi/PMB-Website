    ...
    <ul class="fs-5 list-unstyled ">
        ...
        <li class="py-1">
            <a class="nav-link text-white d-flex align-items-center <?php echo e((Request::is('admin/Request-Pending') or Request::is('admin/Request-Processed') or Request::is('admin/Request-Accepted') or Request::is('admin/Request-detail')) ? 'active' : ''); ?>"
                data-bs-toggle="collapse" href="#collapseRequest" role="button" aria-expanded="<?php echo e((Request::is('admin/Request-Pending') or Request::is('admin/Request-Processed') or Request::is('admin/Request-Accepted') or Request::is('admin/Request-detail')) ? 'true' : 'false'); ?>"
            ...
            <div class="collapse <?php echo e((Request::is('admin/Request-Pending') or Request::is('admin/Request-Processed') or Request::is('admin/Request-Accepted') or Request::is('admin/Request-detail')) ? 'show' : ''); ?>" id="collapseRequest">
        ...
        <li class="py-1">
            <a class="nav-link text-white d-flex align-items-center <?php echo e((Request::is('admin/createEvent') or Request::is('admin/passEvent') or Request::is('admin/scheduledEvent')) ? 'active' : ''); ?>"
                data-bs-toggle="collapse" href="#collapsePelayanan" role="button" aria-expanded="<?php echo e((Request::is('admin/createEvent') or Request::is('admin/passEvent') or Request::is('admin/scheduledEvent')) ? 'true' : 'false'); ?>"
            ...
            <div class="collapse <?php echo e((Request::is('admin/createEvent') or Request::is('admin/passEvent') or Request::is('admin/scheduledEvent')) ? 'show' : ''); ?>" id="collapsePelayanan">
                <ul class="list-unstyled ps-5">
                    <li class="py-1"><a
        ...
        <li class="py-1">
            <a class="nav-link text-white d-flex align-items-center <?php echo e((Request::is('admin/highlight') or Request::is('admin/layanan') or Request::is('admin/doa') or Request::is('admin/pastor') or Request::is('admin/artikel') or Request::is('admin/kegiatan')) ? 'active' : ''); ?>"
                data-bs-toggle="collapse" href="#collapseUserPage" role="button" aria-expanded="<?php echo e((Request::is('admin/highlight') or Request::is('admin/layanan') or Request::is('admin/doa') or Request::is('admin/pastor') or Request::is('admin/artikel') or Request::is('admin/kegiatan')) ? 'true' : 'false'); ?>"
            ...
            <div class="collapse <?php echo e((Request::is('admin/highlight') or Request::is('admin/layanan') or Request::is('admin/doa') or Request::is('admin/pastor') or Request::is('admin/artikel') or Request::is('admin/kegiatan')) ? 'show' : ''); ?>" id="collapseUserPage">
                <ul class="list-unstyled ps-5">
                    <li class="py-1"><a class="nav-link text-white <?php echo e(Request::is('admin/highlight') ? 'active' : ''); ?>" href="/admin/highlight">Highlight</a></li>
                    <li class="py-1"><a class="nav-link text-white <?php echo e(Request::is('admin/layanan') ? 'active' : ''); ?>" href="/admin/layanan">Layanan</a></li>
                    <li class="py-1"><a class="nav-link text-white <?php echo e(Request::is('admin/doa') ? 'active' : ''); ?>" href="/admin/doa">Doa Paroki</a></li>
                    <li class="py-1"><a class="nav-link text-white <?php echo e(Request::is('admin/pastor') ? 'active' : ''); ?>" href="/admin/pastor">Pastor</a></li>
                    <li class="py-1"><a class="nav-link text-white <?php echo e(Request::is('admin/artikel') ? 'active' : ''); ?>" href="/admin/artikel">Artikel</a></li>
                    <li class="py-1"><a class="nav-link text-white <?php echo e(Request::is('admin/kegiatan') ? 'active' : ''); ?>" href="/admin/kegiatan">Kegiatan</a></li>
                </ul>
            </div>
        </li>
