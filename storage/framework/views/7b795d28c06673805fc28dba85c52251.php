...
<div class="container-fluid   sidebar p-3 m-0">
    ...
    <ul class="fs-5 list-unstyled ">
        ...
        <li class="py-1">
            <a class="nav-link text-white d-flex align-items-center <?php echo e((Request::is('admin/New-Event') or Request::is('admin/Passed-Event') or Request::is('admin/Scheduled-Event')) ? 'active' : ''); ?>"
