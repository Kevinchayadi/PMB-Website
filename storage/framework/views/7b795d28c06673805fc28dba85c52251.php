    ...
    <ul class="fs-5 list-unstyled ">
        ...
        <li class="py-1">
            ...
            <div class="collapse" id="collapsePelayanan">
                <ul class="list-unstyled ps-5">
                    <li class="py-1"><a
                            class="nav-link text-white <?php echo e(Request::is('admin/New-Event') ? 'active' : ''); ?>"
                            href="/admin/createEvent">Create New</a></li>
                    <li class="py-1"><a
                            class="nav-link text-white <?php echo e(Request::is('admin/Scheduled-Event') ? 'active' : ''); ?>"
                            href="/admin/scheduledEvent">Scheduled</a></li>
                    <li class="py-1"><a
                            class="nav-link text-white <?php echo e(Request::is('admin/Passed-Event') ? 'active' : ''); ?>"
