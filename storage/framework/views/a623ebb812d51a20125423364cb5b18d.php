                    ...
                    <tbody>
                        <?php $__currentLoopData = $admins; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $admin): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td>
                                    <a href="/admin/admin-detail/<?php echo e($admin->username); ?>"
                                        class="btn btn-sm btn-outline-primary">Edit</a>
                                    <form action="<?php echo e(route('admin.remove', $admin->username)); ?>" method="POST"
                                        class="d-inline">
                                        <?php echo csrf_field(); ?>
        ...
        <?php if($admins->total() > 0): ?>
            ...
            <nav class="mt-2">
                <ul class="pagination justify-content-center mb-0" id="pagination">
                    ...
                    <?php else: ?>
                        <li class="page-item">
                            <a class="page-link" href="<?php echo e($admins->previousPageUrl()); ?>">
                                << /a>
                        </li>
                    <?php endif; ?>
