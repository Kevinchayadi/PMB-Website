    ...
    public function run(): void
    {
        $articles = [
            ...
            [
                ...
                'id_admin' => 1,
                'path' => 'storage/img/article10.jpg',
            ],
        ];
